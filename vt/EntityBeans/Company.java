...
@NamedQueries({
        ...
        , @NamedQuery(name = "Company.findByExchange", query = "SELECT c FROM Company c WHERE c.exchange = :exchange")
        , @NamedQuery(name = "Company.findByTicker", query = "SELECT c FROM Company c WHERE c.ticker = :ticker")
        , @NamedQuery(name = "Company.findByRevenues", query = "SELECT c FROM Company c WHERE c.revenues = :revenues")
        , @NamedQuery(name = "Company.findByDescription", query = "SELECT c FROM Company c WHERE c.description = :description")
        , @NamedQuery(name = "Company.findBySector", query = "SELECT c FROM Company c WHERE c.sector = :sector")
...
public class Company implements Serializable {
    ...
    public Company(Integer id, String name, String exchange, String ticker, String price, String description, String logo, String analystPrice, String revenues, String sector, String website) {
        this.id = id;
        this.name = name;
        this.price = price;
    ...
    public Company(String name, String exchange, String ticker, String price, String description, String logo, String analystPrice, String revenues, String sector, String website) {
        this.name = name;
        this.price = price;
        this.exchange = exchange;
        this.ticker = ticker;
