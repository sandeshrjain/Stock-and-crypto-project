...
import edu.vt.FacadeBeans.UserCompanyFacade;
...
@Named("usercompanyController")
@SessionScoped
public class UserCompanyController implements Serializable {
    /*
    ===============================
    ...
    private boolean companiesDataChanged;
    /*
The @EJB annotation directs the EJB Container Manager to inject (store) the object reference of the
CompanyFacade bean into the instance variable 'companyFacade' after it is instantiated at runtime.
 */
    @EJB
    private UserCompanyFacade userCompanyFacade;
    private UserController userController;

    // 'listOfUserCompanies' is a List containing the object references of Company objects
    private List<UserCompany> listOfUserCompanies = null;


    // 'selected' contains the object reference of the selected Company object
    private UserCompany selected;
    ...
    public UserCompanyFacade getCompanyFacade() {
        return userCompanyFacade;
    }
    ...
    public void setCompanyFacade(UserCompanyFacade userCompanyFacade) {
        this.userCompanyFacade = userCompanyFacade;
    }

    public void setListOfCompanies(List<UserCompany> listOfUserCompanies) {
        this.listOfUserCompanies = listOfUserCompanies;
    }

    public UserCompany getSelected() {
        return selected;
    }

    public void setSelected(UserCompany selected) {
     ...
     *****************************
     If 'listOfUserCompanies' is null, obtain the object references of all of the companies
     in the database, store them in the 'listOfUserCompanies" List, and return the List.
     */
    public List<UserCompany> getListOfUserCompanies() {
        if (listOfUserCompanies == null) {
            Map<String, Object> sessionMap = FacesContext.getCurrentInstance().getExternalContext().getSessionMap();
            User signedInUser = (User) sessionMap.get("user");
            Integer primaryKey = signedInUser.getId();
            listOfUserCompanies = userCompanyFacade.findUserCompaniesByUserPrimaryKey(primaryKey);
        }
        return listOfUserCompanies;
    }
    /*
     ***************************************
    ...
    public void prepareCreate() {
        ...
        Map<String, Object> sessionMap = FacesContext.getCurrentInstance().getExternalContext().getSessionMap();
        User signedInUser = (User) sessionMap.get("user");
        selected = new UserCompany(signedInUser);
    ...
    public void prepareShare(Company u_selected) throws Exception {
        Map<String, Object> sessionMap = FacesContext.getCurrentInstance().getExternalContext().getSessionMap();

        boolean a = sessionMap.get("username") != null;
        if (a) {
            getStockQuote(u_selected.getTicker());
        }

        else {
            JsfUtil.addSuccessMessage2("Unable to Share!", "To share a token a user must have signed in!");
        }
    }
    ...
    public void share() {
        ...
        share_persist(PersistAction.CREATE, "User stock was successfully Created!");


        if (!JsfUtil.isValidationFailed()) {
            // No JSF validation error. The CREATE operation is successfully performed.
            selected = null;            // Remove selection
            listOfUserCompanies = null;     // Invalidate listOfPubliccomapies to trigger re-query.
            companiesDataChanged = true;
        }
    }
    ...
    private void share_persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            try {
                if (persistAction != PersistAction.DELETE) {
                     ...
                     */
                    userCompanyFacade.edit(selected);
                } else {
                    /*
                     -----------------------------------------
                     ...
                     PublicCompanyFacade inherits the remove(selected) method from the AbstractFacade class.
                     */
                    userCompanyFacade.remove(selected);
                }
    ...
    public void create() {
        ...
        if (!JsfUtil.isValidationFailed()) {
            // No JSF validation error. The CREATE operation is successfully performed.
            selected = null;            // Remove selection
            listOfUserCompanies = null;     // Invalidate listOfUserCompanies to trigger re-query
        }
    }
    ...
    public String getStockQuote(String companyStockSymbol) throws Exception {
        ...
        */
        ...
        try {
            ...
            revenue_per_share = stockData.optString("RevenuePerShareTTM", "");
            ...
            ================================
             */
            analystPrice = stockData.optString("AnalystTargetPrice", "");
            ...
            //    https://cloud.iexapis.com/stable/stock/aapl/company?token=pk_372ec0f476c047fd94b9c0947bce3e5d
            /*
                     {
                      "symbol": "AAPL",
...
*/
            //"https://cloud.iexapis.com/stable/stock/aapl/quote?token=pk_372ec0f476c047fd94b9c0947bce3e5d"
        ...
        selected = new UserCompany(companyName, signedInUser, companyExchange, stockSymbol, latestStockPrice, companyDescription, logo, analystPrice, revenue_per_share, companySector, companyWebsite);
        create();
